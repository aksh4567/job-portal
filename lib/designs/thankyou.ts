											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top;">
													<table class="heading_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<h1 style="margin: 0; color: #7747FF; direction: ltr; font-family: Arial, Helvetica, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 1.2; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 46px;"><span class="tinyMce-placeholder" style="word-break: break-word;">Thankyou for Applying</span></h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:left;mso-line-height-alt:19px;">
																	...
																	<p style="margin: 0; margin-bottom: 16px;">Thank you for taking the time to apply. We appreciate your interest in joining our team and considering us as a potential employer.</p>
																	...
																	<p style="margin: 0;">We look forward to potentially working with you and wish you the best of luck in your job search.</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center">
																	<div style="max-width: 150px;"><img src="https://ecf1a11b8c.imgdist.com/pub/bfra/h19skfqc/1a3/lf9/98f/Connecting%20teams-rafiki.svg" style="display: block; height: auto; border: 0; width: 100%;" width="150" alt title height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
