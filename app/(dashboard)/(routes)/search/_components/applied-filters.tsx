...
export const AppliedFilters = ({ categories }: AppliedFiltersProps) => {
  ...
  const workExperienceParams = Object.fromEntries(
  ...
  return (
    <>
      <div className="mt-4 flex items-center gap-4">
        ...
        {shiftTimingParams.shiftTiming?.split(",").map((item) => (
          <Button
            variant="outline"
            key={item}
            type="button"
        ...
        {workingModesParams.workMode?.split(",").map((item) => (
          <Button
            variant="outline"
            key={item}
            type="button"
        ...
        {workExperienceParams.yearsOfExperience?.split(",").map((item) => (
          <Button
            variant="outline"
            key={item}
            type="button"
